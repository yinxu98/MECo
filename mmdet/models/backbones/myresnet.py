...
class MyResNet(BaseModule):
    ...
    def __init__(self,
        ...
        if init_cfg is None:
            ...
            file_pretrained = init_cfg['checkpoint']
        ...
        if self.pretrained:
            self.load_state_dict(torch.load(file_pretrained))
            print(f'==> Backbone loaded from {file_pretrained}')
...
class MyResNetV1d(MyResNet):
    ...
    def __init__(self, **kwargs):
        super(MyResNetV1d, self).__init__(deep_stem=True,
                                          avg_down=True,
                                          **kwargs)
